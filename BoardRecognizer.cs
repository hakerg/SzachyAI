...
namespace SzachyAI
{
    public class BoardRecognizer
    {
        ...
        public Image<Bgr, byte>[,,] templatePieces = new Image<Bgr, byte>[2, 2, 6];
        public Image<Bgr, byte>[] templateFields = new Image<Bgr, byte>[2];
        ...
        public void LoadTemplate(string templatePath)
        {
            ...
            boardSize = new Size(fieldSize.Width * 8, fieldSize.Height * 8);
            ...
            for (int y = 0; y < 8; y++)
            {
                for (int x = 0; x < 8; x++)
                {
                    ...
                    if (bestPieceScore < fieldScore)
                    {
                        ...
                        board.AddPiece(new Piece(pos, (Piece.Type)bestP, (Color)bestPC, false));
                    }
                }
            }
            boardImage.ROI = Rectangle.Empty;
